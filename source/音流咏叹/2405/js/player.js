...
class Musics {
    ...
    constructor() {
        this.songs = [{
            ...
            title: 'ONE',
            singer: 'Aimer',
            songUrl: './songs/ONE-Aimer.mp3',
            imageUrl: './images/songs/ONE-Aimer.jpg'
        },
        {
            id: 2,
            title: 'Into the I-LAND',
            singer: 'IU',
            songUrl: './songs/IU - Into the I-LAND.mp3',
            imageUrl: './images/songs/IU - Into the I-LAND.jpg'
        },
        {
            id: 3,
            title: 'Inferno',
            singer: '泽野弘之/mpi/Benjamin',
            songUrl: './songs/Inferno 泽野弘之mpiBenjamin.mp3',
            imageUrl: './images/songs/Inferno 泽野弘之mpiBenjamin.jpg'
        },
        {
            id: 4,
            title: 'Hands Up to the Sky',
            singer: '泽野弘之/Laco',
            songUrl: './songs/Hands Up to the Sky 泽野弘之Laco.mp3',
            imageUrl: './images/songs/Hands Up to the Sky 泽野弘之Laco.jpg'
        },
        {
            id: 5,
            title: 'Rise',
            singer: 'Jonas Blue ft IZONE',
            songUrl: './songs/Rise - Jonas Blue ft IZONE.mp3',
            imageUrl: './images/songs/Rise - Jonas Blue ft IZONE.jpg'
        },
        {
            id: 6,
            title: 'ピースサイン',
            singer: '米津玄師',
            songUrl: './songs/ピースサイン - 米津玄師.mp3',
            imageUrl: './images/songs/ピースサイン - 米津玄師.jpg'
        },
        {
            id: 7,
            title: '群青',
        ...
        },
        {
            ...
            title: 'HAPPY',
            singer: 'DAY6',
            songUrl: './songs/DAY6 - HAPPY.mp3',
            imageUrl: './images/songs/DAY6 - HAPPY.jpg'
        },
        {
            id: 10,
            title: 'Masayume Chasing',
            singer: 'BoA',
            songUrl: './songs/BoA-Masayume Chasing.mp3',
            imageUrl: './images/songs/BoA-Masayume Chasing.jpg'
        },
