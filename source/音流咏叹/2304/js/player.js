...
class Musics {
    ...
    constructor() {
        this.songs = [{
            id: 1,
            title: 'キミが残した世界で（你留下的世界）',
            singer: '菅原纱由理（THE SxPLAY）',
            songUrl: './songs/菅原纱由理（THE SxPLAY） - キミが残した世界で（你留下的世界）.mp3',
            imageUrl: './images/songs/菅原纱由理（THE SxPLAY） - キミが残した世界で（你留下的世界）.jpg'
        },
        {
            id: 2,
            title: '7月7日 (One Of These Nights)',
            singer: 'Red Velvet',
            songUrl: './songs/Red Velvet - 7月7日 (One Of These Nights).mp3',
            imageUrl: './images/songs/Red Velvet - 7月7日 (One Of These Nights).jpg'
        },
        {
            id: 3,
            title: '紙一重',
            singer: 'Uru',
            songUrl: './songs/Uru「紙一重」.mp3',
            imageUrl: './images/songs/Uru「紙一重」.jpg'
        },
        {
            id: 4,
            title: 'Shelter',
            singer: 'Porter Robinson & Madeon',
            songUrl: './songs/Shelter  Porter Robinson & Madeon.mp3',
            imageUrl: './images/songs/Shelter  Porter Robinson & Madeon.jpg'
        },
        {
            id: 5,
            title: '在这个世界相遇',
            singer: '陈奕迅',
            songUrl: './songs/陈奕迅 - 在这个世界相遇.mp3',
            imageUrl: './images/songs/陈奕迅 - 在这个世界相遇.jpg'
        },
        {
            id: 6,
            title: 'Sincerely',
        ...
        },
        {
            ...
            title: 'Lemon',
            singer: '米津玄师',
            songUrl: './songs/米津玄师《Lemon》.mp3',
            imageUrl: './images/songs/米津玄师《Lemon》.jpg'
        },
        {
            id: 8,
            title: '句号',
            singer: 'G.E.M.邓紫棋',
            songUrl: './songs/【G.E.M.邓紫棋】 句号 .mp3',
            imageUrl: './images/songs/【G.E.M.邓紫棋】 句号 .jpg'
        },
        {
            id: 9,
            title: 'One Last Kiss',
            singer: '宇多田光',
            songUrl: './songs/宇多田光《One Last Kiss》.mp3',
            imageUrl: './images/songs/宇多田光《One Last Kiss》.jpg'
        },
        {
            id: 10,
            title: 'Da Capo',
            singer: '车子玉Ziyu Che(HOYO-MiX)',
            songUrl: './songs/「Da Capo」车子玉Ziyu Che(HOYO-MiX).mp3',
            imageUrl: './images/songs/「Da Capo」车子玉Ziyu Che(HOYO-MiX).jpg'
        },
