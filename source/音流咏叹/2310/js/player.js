...
class Musics {
    ...
    constructor() {
        this.songs = [{
            ...
            title: 'GRL GVNG',
            singer: 'XG',
            songUrl: './songs/XG GRL GVNG.mp3',
            imageUrl: './images/songs/XG GRL GVNG.jpg'
        },
        {
            id: 2,
            title: 'Girls’ Capitalism',
            singer: 'tripleS LOVElution',
            songUrl: './songs/tripleS LOVElution - Girls’ Capitalism.mp3',
            imageUrl: './images/songs/tripleS LOVElution - Girls’ Capitalism.jpg'
        },
        {
            id: 3,
            title: 'Girls',
        ...
        },
        {
            ...
            title: 'Queendom',
            singer: 'Red Velvet',
            songUrl: './songs/Red Velvet  Queendom.mp3',
            imageUrl: './images/songs/Red Velvet  Queendom.jpg'
        },
        {
            id: 5,
            title: 'GirlsSpkOut',
            singer: '泰妍（feat.Chanmina）',
            songUrl: './songs/泰妍《GirlsSpkOut》（feat.Chanmina）.mp3',
            imageUrl: './images/songs/泰妍《GirlsSpkOut》（feat.Chanmina）.jpg'
        },
        {
            id: 6,
            title: 'TOMBOY',
            singer: '(G)I-DLE',
            songUrl: './songs/(G)I-DLE TOMBOY.mp3',
            imageUrl: './images/songs/(G)I-DLE TOMBOY.jpg'
        },
        {
            id: 7,
            title: 'SLAY',
            singer: 'EVERGLOW',
            songUrl: './songs/EVERGLOW - SLAY.mp3',
            imageUrl: './images/songs/EVERGLOW - SLAY.jpg'
        },
        {
            id: 8,
            title: 'ANTIFRAGILE',
            singer: 'LE SSERAFIM',
            songUrl: './songs/LE SSERAFIM《ANTIFRAGILE》.mp3',
            imageUrl: './images/songs/LE SSERAFIM《ANTIFRAGILE》.jpg'
        },
        {
            id: 9,
            title: 'Wannabe',
            singer: 'itzy',
            songUrl: './songs/【itzy】wannabe.mp3',
            imageUrl: './images/songs/【itzy】wannabe.jpg'
        },
        {
            id: 10,
            title: 'Breakthrough',
            singer: 'TWICE',
            songUrl: './songs/TWICE - Breakthrough.mp3',
            imageUrl: './images/songs/TWICE - Breakthrough.jpg'
        },
