...
class Musics {
    ...
    constructor() {
        this.songs = [{
            ...
            title: 'Island',
            singer: 'PLAVE',
            songUrl: './songs/《Island》-PLAVE.mp3',
            imageUrl: './images/songs/《Island》-PLAVE.jpg'
        },
        {
            id: 2,
            title: '10000 Hours',
            singer: 'Dan&Shay&Justin Bieber',
            songUrl: './songs/10000 Hours.mp3',
            imageUrl: './images/songs/10000 Hours.jpg'
        },
        {
            id: 3,
            title: 'A Thousand Yeas',
            singer: 'Christina Perri',
            songUrl: './songs/A Thousand Yeas.mp3',
            imageUrl: './images/songs/A Thousand Yeas.jpg'
        },
        {
            id: 4,
            title: 'Forest',
            singer: 'Choi Yuree',
            songUrl: './songs/Forest.mp3',
            imageUrl: './images/songs/Forest.jpg'
        },
        {
            id: 5,
            title: 'Love You With All My Heart',
            singer: 'Yejun&Eunho',
            songUrl: './songs/Love You With All My Heart.mp3',
            imageUrl: './images/songs/Love You With All My Heart.jpg'
        },
        {
            id: 6,
            title: 'Rewrite The Stars',
            singer: '马戏之王',
            songUrl: './songs/Rewrite The Stars.mp3',
            imageUrl: './images/songs/Rewrite The Stars.jpg'
        },
        {
            id: 7,
            title: 'I will give you all',
            singer: '李胜哲',
            songUrl: './songs/李胜哲 - I will give you all.mp3',
            imageUrl: './images/songs/李胜哲 - I will give you all.jpg'
        },
        {
            id: 8,
            title: 'try',
            singer: 'Asher Book',
            songUrl: './songs/try.mp3',
            imageUrl: './images/songs/try.jpg'
        },
        {
            id: 9,
            title: 'Make Me Love You',
            singer: '太妍',
            songUrl: './songs/太妍 Make Me Love You.mp3',
            imageUrl: './images/songs/太妍 Make Me Love You.jpg'
        },
        {
            id: 10,
            title: '为了你唱下去',
            singer: '洛天依',
            songUrl: './songs/为了你唱下去.mp3',
            imageUrl: './images/songs/为了你唱下去.jpg'
        },
        ]
    }
    //根据索引获取歌曲的方法
