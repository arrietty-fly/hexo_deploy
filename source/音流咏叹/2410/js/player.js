...
class Musics {
    ...
    constructor() {
        this.songs = [{
            ...
            title: 'ASAP',
            singer: 'NewJeans',
            songUrl: './songs/ASAP NewJeans.mp3',
            imageUrl: './images/songs/ASAP NewJeans.jpg'
        },
        {
            id: 2,
            title: '4 Walls',
            singer: 'f(x)',
            songUrl: './songs/4 Walls.mp3',
            imageUrl: './images/songs/4 Walls.jpg'
        },
        {
            id: 3,
            title: 'IYKYK',
            singer: 'XG',
            songUrl: './songs/XG《IYKYK》.mp3',
            imageUrl: './images/songs/XG《IYKYK》.jpg'
        },
        {
            id: 4,
            title: 'OMG',
            singer: 'NewJeans',
            songUrl: './songs/OMG - NewJeans.mp3',
            imageUrl: './images/songs/OMG - NewJeans.jpg'
        },
        {
            id: 5,
            title: 'ALIEN',
            singer: '李秀贤',
            songUrl: './songs/李秀贤 ALIEN.mp3',
            imageUrl: './images/songs/李秀贤 ALIEN.jpg'
        },
        {
            id: 6,
            title: 'Closer',
            singer: 'OH MY GIRL',
            songUrl: './songs/OH MY GIRL Closer.mp3',
            imageUrl: './images/songs/OH MY GIRL Closer.jpg'
        },
        {
            id: 7,
            title: 'Dreams Come True',
            singer: 'aespa',
            songUrl: './songs/aespa Dreams Come True.mp3',
            imageUrl: './images/songs/aespa Dreams Come True.jpg'
        },
        {
            id: 8,
            title: 'Virtual Angel',
            singer: 'ARTMS',
            songUrl: './songs/ARTMS-Virtual Angel.mp3',
            imageUrl: './images/songs/ARTMS-Virtual Angel.jpg'
        },
        {
            id: 9,
            title: 'String Theocracy',
            singer: 'Mili',
            songUrl: './songs/Mili - String Theocracy.mp3',
            imageUrl: './images/songs/Mili - String Theocracy.jpg'
        },
        {
            id: 10,
            title: 'Off the Record',
            singer: 'IVE',
            songUrl: './songs/IVE《Off the Record》.mp3',
            imageUrl: './images/songs/IVE《Off the Record》.jpg'
        },
        ]
    }
    //根据索引获取歌曲的方法
