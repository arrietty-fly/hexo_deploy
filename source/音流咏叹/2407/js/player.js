...
class Musics {
    ...
    constructor() {
        this.songs = [{
            ...
            title: 'Ref：rain',
            singer: 'Aimer',
            songUrl: './songs/Aimer - Ref：rain.mp3',
            imageUrl: './images/songs/Aimer - Ref：rain.jpg'
        },
        {
            id: 2,
            title: 'Love wins all',
            singer: 'IU',
            songUrl: './songs/IU Love wins all.mp3',
            imageUrl: './images/songs/IU Love wins all.jpg'
        },
        {
            id: 3,
            title: 'You Were Beautiful',
            singer: 'PLAVE',
            songUrl: './songs/PLAVE - You Were Beautiful.mp3',
            imageUrl: './images/songs/PLAVE - You Were Beautiful.jpg'
        },
        {
            id: 4,
            title: '透明',
            singer: 'G.E.M.邓紫棋',
            songUrl: './songs/【G.E.M.邓紫棋】 透明.mp3',
            imageUrl: './images/songs/【G.E.M.邓紫棋】 透明.jpg'
        },
        {
            id: 5,
            title: '追光者',
            singer: '岑宁儿',
            songUrl: './songs/追光者 - 岑宁儿.mp3',
            imageUrl: './images/songs/追光者 - 岑宁儿.jpg'
        },
        {
            id: 6,
            title: 'エイミー',
            singer: '茅原实里',
            songUrl: './songs/《エイミー》茅原实里.mp3',
            imageUrl: './images/songs/《エイミー》茅原实里.jpg'
        },
        {
            id: 7,
            title: '不再见',
            singer: '陈学冬',
            songUrl: './songs/陈学冬-不再见.mp3',
            imageUrl: './images/songs/陈学冬-不再见.jpg'
        },
        {
            id: 8,
            title: 'All For Nothing',
            singer: '金泰妍',
            songUrl: './songs/金泰妍《All For Nothing》.mp3',
            imageUrl: './images/songs/金泰妍《All For Nothing》.jpg'
        },
        {
            id: 9,
            title: '小幸运',
            singer: '田馥甄',
            songUrl: './songs/田馥甄《小幸运》.mp3',
            imageUrl: './images/songs/田馥甄《小幸运》.jpg'
        },
        {
            id: 10,
            title: '你不知道的事',
            singer: '王力宏',
            songUrl: './songs/王力宏 你不知道的事.mp3',
            imageUrl: './images/songs/王力宏 你不知道的事.jpg'
        },
