...
class Musics {
    ...
    constructor() {
        this.songs = [{
            ...
            title: 'Rubia',
            singer: '周深',
            songUrl: './songs/周深《Rubia》.mp3',
            imageUrl: './images/songs/周深《Rubia》.jpg'
        },
        {
            id: 2,
            title: 'Torches',
            singer: 'Aimer',
            songUrl: './songs/Aimer「Torches」.mp3',
            imageUrl: './images/songs/Aimer「Torches」.jpg'
        },
        {
            id: 3,
            title: 'みちしるべ（路标）',
        ...
        },
        {
            ...
            singer: 'aespa',
            songUrl: './songs/aespa Welcome to my world.mp3',
            imageUrl: './images/songs/aespa Welcome to my world.jpg'
        },
        {
            id: 6,
            title: 'The Cure',
            singer: 'sm队长',
            songUrl: './songs/安七炫xBoAx郑允浩x金泰妍x利特x温流xSUHOx裴珠泫x李泰容x李马克xKUN The Cure.mp3',
            imageUrl: './images/songs/安七炫xBoAx郑允浩x金泰妍x利特x温流xSUHOx裴珠泫x李泰容x李马克xKUN The Cure.jpg'
        },
        {
            id: 7,
            title: '来吧，甜蜜的死亡',
            singer: 'EVA',
            songUrl: './songs/来吧，甜蜜的死亡.mp3',
            imageUrl: './images/songs/来吧，甜蜜的死亡.jpg'
        },
        {
            id: 8,
            title: 'Summer Ghost',
        ...
        },
        {
            id: 10,
            title: 'MOTHER',
            singer: 'VOICES FROM MARS',
            songUrl: './songs/CAROLE & TUESDAY「 MOTHER 」.mp3',
            imageUrl: './images/songs/CAROLE & TUESDAY「 MOTHER 」.jpg'
        },
