...
class Musics {
    ...
    constructor() {
        this.songs = [{
            ...
            singer: 'IZ*ONE',
            songUrl: './songs/IZ_ONE -《La Vie en Rose》.mp3',
            imageUrl: './images/songs/IZ_ONE -《La Vie en Rose》.jpg'
        },
        {
            id: 2,
            title: 'Swan Song',
            singer: 'LE SSERAFIM',
            songUrl: './songs/LE SSERAFIM《Swan Song》.mp3',
            imageUrl: './images/songs/LE SSERAFIM《Swan Song》.jpg'
        },
        {
            id: 3,
            title: 'AYAYAYA',
            singer: 'IZ*ONE',
            songUrl: './songs/IZ_ONE AYAYAYA.mp3',
            imageUrl: './images/songs/IZ_ONE AYAYAYA.jpg'
        },
        {
            id: 4,
            title: 'Bejeweled',
            singer: 'Taylor Swift',
            songUrl: './songs/Taylor Swift - Bejeweled.mp3',
            imageUrl: './images/songs/Taylor Swift - Bejeweled.jpg'
        },
        {
            id: 5,
            title: '楼宇间盛开的玫瑰(Rose Blossom)',
            singer: 'H1-KEY',
            songUrl: './songs/H1-KEY - 楼宇间盛开的玫瑰(Rose Blossom).mp3',
            imageUrl: './images/songs/H1-KEY - 楼宇间盛开的玫瑰(Rose Blossom).jpg'
        },
        {
            id: 6,
            title: 'Palette',
            singer: 'IU',
            songUrl: './songs/IU《Palette》.mp3',
            imageUrl: './images/songs/IU《Palette》.jpg'
        },
        {
            id: 7,
            title: 'Sugarcoat',
            singer: 'Natty',
            songUrl: './songs/《Sugarcoat》_Natty.mp3',
            imageUrl: './images/songs/《Sugarcoat》_Natty.jpg'
        },
        {
            id: 8,
            title: '红色高跟鞋',
            singer: '蔡健雅',
            songUrl: './songs/红色高跟鞋 蔡健雅.mp3',
            imageUrl: './images/songs/红色高跟鞋 蔡健雅.jpg'
        },
        {
            id: 9,
            title: '不死蝶',
            singer: 'Mili',
            songUrl: './songs/Mili - 不死蝶.mp3',
            imageUrl: './images/songs/Mili - 不死蝶.jpg'
        },
        {
            id: 10,
            title: '一身焰火去罗马',
            singer: '莫文蔚 & The Masters',
            songUrl: './songs/莫文蔚 & The Masters《一身焰火去罗马》.mp3',
            imageUrl: './images/songs/莫文蔚 & The Masters《一身焰火去罗马》.jpg'
        },
        ]
    }
    //根据索引获取歌曲的方法
