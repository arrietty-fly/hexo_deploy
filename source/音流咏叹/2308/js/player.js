...
class Musics {
    ...
    constructor() {
        this.songs = [{
            ...
            singer: 'Lyn',
            songUrl: './songs/女神异闻录5 - Life Will Change.mp3',
            imageUrl: './images/songs/女神异闻录5 - Life Will Change.jpg'
        },
        {
            id: 2,
            title: '弈',
            singer: '洛天依',
            songUrl: './songs/【洛天依V4V5】弈【AtonyP】.mp3',
            imageUrl: './images/songs/【洛天依V4V5】弈【AtonyP】.jpg'
        },
        {
            id: 3,
            title: 'GODS',
        ...
        {
            id: 6,
            title: '达拉崩吧·史诗版（管弦REMIX）',
            singer: 'Vsinger全员',
            songUrl: './songs/达拉崩吧·史诗版（管弦REMIX）.mp3',
            imageUrl: './images/songs/达拉崩吧·史诗版（管弦REMIX）.jpg'
        },
        {
            id: 7,
            title: 'Last Resort',
        ...
        },
        {
            ...
            title: 'FAKEit',
            singer: '泽野弘之&Laco',
            songUrl: './songs/FAKEit - 泽野弘之&Laco.mp3',
            imageUrl: './images/songs/FAKEit - 泽野弘之&Laco.jpg'
        },
        {
            id: 10,
            title: '晨昏线',
